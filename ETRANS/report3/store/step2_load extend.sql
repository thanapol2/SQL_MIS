...
FROM
    (
        ...
        FROM
            ...
            CROSS JOIN (
                SELECT
                    trunc(TO_DATE('01/02/2016', 'dd/mm/yyyy'), 'mm') month_year
                FROM
                    dual
            ) t
...
--    raw
                SELECT
                    md.region_no,
                    trunc(TO_DATE('01/02/2016', 'dd/mm/yyyy')) AS month_year,
                ...
                FROM
                    (
                        ...
                        WHERE
                            status = 'APPROVE'
-- check expire date
                            AND months_between(trunc(TO_DATE('01/02/2016', 'dd/mm/yyyy')), trunc(updated_date)) BETWEEN 10 AND 12  
