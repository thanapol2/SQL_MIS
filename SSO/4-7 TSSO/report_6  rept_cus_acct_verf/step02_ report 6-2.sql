SELECT ''                                         AS id,
  ...
  ACCESS_USER_TYPE_ID,
  '' as ACCESS_USER_TYPE,
  ACCT_VERF_STATUS_ID          AS ACCESS_USER_TYPE_STATUS_ID,
  ''                           AS ACCESS_USER_TYPE_STATUS,
  USERID_CUS_CNT,
  USERID_CUS_CNT_PERT,
  SYSDATE create_dtm,
  'RAW' create_user_id
FROM
  ...
  CROSS JOIN
    -- MST_ACCT_VERF_STATUS cross join mst_USER_LEVEL_CODE
    (
    SELECT ACTIVATE_STATUS_CODE AS ACCT_VERF_STATUS_ID,
      USER_LEVEL_CODE           AS ACCESS_USER_TYPE_ID,
